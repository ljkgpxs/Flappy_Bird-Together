...
import com.github.ljkgpxs.listeners.OnWeaponBulletAddListener;
...
import com.github.ljkgpxs.utils.WeaponType;
...
public class Player extends Sprite {
    ...
    public Player() {
        ...
        try {
            mAnimator.addFrame(ImageIO.read(this.getClass().getResource("/resources/bird0_0.png")));
            mAnimator.addFrame(ImageIO.read(this.getClass().getResource("/resources/bird0_1.png")));
            mAnimator.addFrame(ImageIO.read(this.getClass().getResource("/resources/bird0_2.png")));
            mSkillSpeedUp = ImageIO.read(this.getClass().getResource("/resources/speed_up.png"));
            mSkillLoading = ImageIO.read(this.getClass().getResource("/resources/skill_loading.png"));
            mWeaponSlot = ImageIO.read(this.getClass().getResource("/resources/weapon_slot.png"));
            mGunImage = ImageIO.read(this.getClass().getResource("/resources/gun.png"));
            mFireImage = ImageIO.read(this.getClass().getResource("/resources/fire.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void paint(Graphics graphics) {
        ...
        if (System.currentTimeMillis() - mSkillSpeedUpTimer < 5000) {
            graphics.drawImage(mSkillLoading,
                    ...
                    60, 60,
                    null);
            //graphics.setFont(new Font(this.getClass().getResource("/resources/fonts/arial.ttf"), ));
            try {
                graphics.setFont(Font.createFont(Font.TRUETYPE_FONT,
                        this.getClass().getResourceAsStream("/resources/fonts/Marker Felt.ttf")));
